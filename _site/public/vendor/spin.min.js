!(function (t, e, i) {
	...
	c(m.prototype, {
		spin: function (t) {
			...
			var e = this,
				i = e.opts,
				o = (e.el = u(a(0, { className: i.className }), {
					position: i.position,
					width: 0,
					zIndex: i.zIndex,
				})),
			...
			if (t) {
				...
				u(o, {
					left:
						(i.left == "auto"
							? f.x - s.x + (t.offsetWidth >> 1)
							: parseInt(i.left, 10) + r) + "px",
					top:
						(i.top == "auto"
							? f.y - s.y + (t.offsetHeight >> 1)
							: parseInt(i.top, 10) + r) + "px",
				});
			}
	...
	(function () {
		...
		if (!p(e, "transform") && e.adj) {
			...
			m.prototype.lines = function (e, i) {
				...
				function n() {
					return u(
						t("group", { coordsize: r + " " + r, coordorigin: -o + " " + -o }),
						{ width: r, height: r },
					);
				}
				var a = -(i.width + i.length) * 2 + "px",
					f = u(n(), { position: "absolute", top: a, left: a }),
					l;
				function p(e, r, a) {
					s(
						f,
						s(
							u(n(), { rotation: (360 / i.lines) * e + "deg", left: ~~r }),
							s(
								u(t("roundrect", { arcsize: i.corners }), {
									width: o,
									height: i.width,
									left: i.radius,
									top: -i.width >> 1,
								...
								t("fill", { color: i.color, opacity: i.opacity }),
								t("stroke", { opacity: 0 }),
							),
						),
					);
